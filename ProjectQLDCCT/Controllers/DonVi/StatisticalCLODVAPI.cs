...
{
    [Route("api/donvi/statistical-clo")]
    [ApiController]
    public class StatisticalCLODVAPI : ControllerBase
    {
        private readonly QLDCContext db;
        private readonly int unixTimestamp;
        public StatisticalCLODVAPI(QLDCContext _db)
        {
            db = _db;
        ...
        public async Task<IActionResult> LoadStaCLO([FromBody] StatisticalCLODTOs items)
        {
            ...
            return Ok(new { data = ListData, message ="Tải dữ liệu thành công",success = true });
        }
    }
}
